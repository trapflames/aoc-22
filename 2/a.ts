...
const evaluateWinner = (a:string,b:string) => {
    ...
    else if((shapePointsP1 === 1 && shapePointsP2 === 3) || (shapePointsP1 === 2 && shapePointsP2 === 1) || (shapePointsP1 === 3 && shapePointsP2 === 2)){
...
for(const i in player1){
    const points = evaluateWinner(player1[i], player2[i])
